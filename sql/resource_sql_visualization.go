...
func ResourceSqlVisualization() common.Resource {
	...
	return common.Resource{
		DeprecationMessage: "This resource is deprecated and will be no longer supported on March 2, 2026. Please switch to databricks_dashboard to author new AI/BI dashboards using the latest tooling.",
