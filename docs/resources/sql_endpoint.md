...
* `data_source_id` - (Deprecated, will be no longer supported on March 2, 2026) ID of the data source for this endpoint. This is used to bind an Databricks SQL query to an endpoint.
